...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1013d_startup_from_sd_card.elf

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1013d_startup_from_sd_card.elf: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_1013d_startup_from_sd_card.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -T./fnirsi_1013d.ld -nostdlib -lgcc
...
${OBJECTDIR}/fnirsi_1013d_startup_from_sd_card.o: fnirsi_1013d_startup_from_sd_card.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fnirsi_1013d_startup_from_sd_card.o fnirsi_1013d_startup_from_sd_card.c
